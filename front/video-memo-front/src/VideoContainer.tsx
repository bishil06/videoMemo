...
export default function VideoContainer({ appSize, videoPath, memoList, pushMemoList }: { videoPath: string,  appSize: { width: number, height: number }, memoList: Array<{ [k: string]: string | number }>, pushMemoList: (obj: { [k: string]: string | number })=>void  }) {
